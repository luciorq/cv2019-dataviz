# Curso de verao em Bioinformatica
# Introducao ao R
...
list(pedido_id = 8001406,
     pedido_registro = "2018-05-25",
     nome = "Jose",
     sobrenome = "Maria Jota")
...
5 %% 3  # resto da divisao de 5 por 3

5 %/% 3  # parte inteira da divisao de 5 por 3
...
# Esta operacao sobreescreve a variavel que antes continha
# o valor de pi
pi
pi <- 5 ## cuidado!
pi
...
n <- matrix( c(c(1,2,3),c(4,5,6)), nrow = 3, ncol = 2)
...
if ( x == 1 ) {
  Sys.time()      # Imprime a data/hora no momento da execucao.
}
...
## Como crair suas proprias funcoes
...
# tabela_brca <- read.csv("resultados/tabela_brca.csv", row.names = 1)
